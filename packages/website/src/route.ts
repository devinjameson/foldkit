...
// Listed rather than derived by subtraction, so adding a route to `AppRoute`
// is a deliberate choice about whether it belongs to the documentation
// section rather than a silent join.
