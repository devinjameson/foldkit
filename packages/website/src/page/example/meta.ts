...
export const examples: ReadonlyArray<ExampleMeta> = [
  ...
  },
  {
    ...
    description:
      'A task list persisted in IndexedDB that stays live across browser tabs on one device. Writes commit through Commands and announce over a BroadcastChannel, a single Subscription reloads the projection on every change, and the Model holds the store as AsyncData. This is the integration shape a local-first store would slot into.',
    difficulty: 'Advanced',
