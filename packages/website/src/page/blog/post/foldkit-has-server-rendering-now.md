...
None of this is required. A Foldkit app can still be a pure client-side SPA with no server rendering at all, unchanged from before. Server rendering is a choice you opt into, not a new default.
