...
| `data-placement`     | Present on the calendar panel when lockPlacement is true, set to the locked side: top, right, bottom, or left.                                                                |
...
| `anchor`                                 | `AnchorConfig`                                   | —       | Popover positioning config (placement, gap, offset, padding, lockPlacement). Controls where the calendar panel floats relative to the trigger.                                                                                                                                            |
